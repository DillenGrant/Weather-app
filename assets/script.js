function createCityList(citySearchList) {
  ...
  function populateCityWeather(city, citySearchList) {
    ...
    var queryURL =
      "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=2c48023ff32014febde54e6be23396d0&q=" +
      city;
  
    var queryURL2 =
      "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=2c48023ff32014febde54e6be23396d0&q=" +
      city;
    ...
    $.ajax({
      ...
      .then(function(weather) {
        ...
        var queryURL3 =
          "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=2c48023ff32014febde54e6be23396d0&q=" +
          "&lat=" +
          latitude +
          "&lon=" +
          longitude;
